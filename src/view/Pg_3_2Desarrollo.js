    ...
    <>
      <section className="container-fluid ">
        <div className="row align-items-center align-content-center">
          <div className="my-5 d-flex align-items-center  col-md-6 col-lg-6 col-xl-4">
        ...
        <a href="#regreso" className="btn btn-primary me-1 me-sm-3"><i className="fas fa-arrow-up"></i>
        </a>
        <p className="subir-next mb-0 font-serif text-secondary">Subir</p>
        </div>  
        <div className="d-flex align-items-center"> 
        <button className="btn btn-primary order-1 ms-1 ms-sm-3"><i className="fas fa-arrow-right"></i>
        </button>
        <p className="subir-next mb-0 font-serif text-secondary">Ver siguiente proyecto</p>
        </div>  
        </div>
      </section>
    </>
