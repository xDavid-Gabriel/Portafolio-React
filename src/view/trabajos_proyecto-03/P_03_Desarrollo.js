...
export default function P_03_Desarrollo() {
  return (
    <>
      <section className="container-fluid ">
        <div className="row align-items-center align-content-center">
          ...
          <div className="col-md-6 col-lg-6 col-xl-5 " data-aos="fade-right">
            <p>
            Se usó React para poder realizarlos, las librerías utilizadas fue Tailwind CSS para los estilos, y lo más importante para poder implementar los gráficos, se utilizó la librería Syncfusion.
            </p>
          </div>

          <div className="brawl mt-3 mb-1 col-12 col-md-6">
            <img className="img-fluid" src={imagenes.img43} alt="Publicacion" />
          </div>
          <div className="brawl mt-3 mb-1 col-12 col-md-6">
            <img className="img-fluid" src={imagenes.img44} alt="Publicacion" />
          </div>
          <div className="brawl mt-3 mb-1 col-12 col-md-6">
            <img className="img-fluid" src={imagenes.img45} alt="Publicacion" />
          </div>
          <div className="brawl mt-3 mb-1 col-12 col-md-6">
            <img className="img-fluid" src={imagenes.img46} alt="Publicacion" />
          </div>
        </div>
