    ...
    <>
      <section className="container-fluid ">
        <div className="overflow-hidden row align-items-center align-content-center pagina">
          <div
            className="my-5 d-flex align-items-center  col-md-7 col-lg-9"
            data-aos="fade-left"
          >
          ...
          <div
            className="my-4 col-sm-6 d-flex justify-content-center"
            data-aos="flip-down"
          >
          ...
          <div
            className="mt-4 mb-5 col-sm-6  d-flex justify-content-center"
            data-aos="flip-down"
          >
